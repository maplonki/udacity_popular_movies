...
public class MovieGridFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mMovieList = savedInstanceState.getParcelableArrayList(Constants.EXTRAS_KEY_MOVIE_LIST);
            mIsPopular = savedInstanceState.getBoolean(Constants.EXTRAS_KEY_IS_POPULAR);
        }
    }
    ...
    private void initRecyclerView() {
        if (mRecyclerView != null && mMovieList != null) {
            ...
            params.putParcelable(Constants.EXTRAS_KEY_MOVIE, mMovieList.get(0));
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelableArrayList(Constants.EXTRAS_KEY_MOVIE_LIST, (ArrayList<MovieModel>) mMovieList);
        outState.putBoolean(Constants.EXTRAS_KEY_IS_POPULAR, mIsPopular);
    }
